...
const Footer = () => {
  return (
        <footer className='relative w-full bg-linear from-[#0C3966] via-[#031221] to-[#0C3966] border border-[#D9D9D9] pt-[60] md:pt-20 lg:pt-[100px] px-8 md:px-12 lg:px-[70px] pb-3 md:pb-4 lg:pb-5 rounded-3xl backdrop-blur-xl'>
